...
const DetailsPage = () => {
  ...
  return(
  <div className="mt-4">
    <Link to="/" className="custom-link-button">Back Home</Link>
    <div className="d-flex m-3 align-items-center details-title ">
        {data?.image?.small && <><Image src={data.image.small} alt={data.name} /><span className="ms-1"><h3 className="m-0">{data.name}</h3></span></>}
    </div> 
